...
@router.get(
    "/staff/educators/{educator_id}/profile/subject-assignments",
    response_model=List[SubjectEducatorResponse],
)
...
@router.get(
    "/staff/educators/{educator_id}/profile/mentored-departments",
...
@router.get(
    "/staff/educators/{educator_id}/profile/supervised-classes",
