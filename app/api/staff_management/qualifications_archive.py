...
from app.core.staff_management.schemas.qualification import QualificationResponse, QualificationFilterParams
...
from app.core.auth.services.dependencies.current_user_deps import get_authenticated_crud, get_crud
