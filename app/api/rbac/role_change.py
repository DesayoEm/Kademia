...
@router.get(
    "/archive/role_history/{permissions_change_id}/audit",
    response_model=RoleHistoryAudit,
)
...
@router.get(
    "/archive/permission_changes/{permissions_change_id}",
...
@router.get(
    "/permission_changes/{permissions_change_id}/audit", response_model=RoleHistoryAudit
)
...
@router.get(
    "/permission_changes/{permissions_change_id}", response_model=RoleHistoryResponse
)
def get_role_change(
    role_change_id: UUID,
    factory: RoleHistoryFactory = Depends(
