...
def get_archived_levels(
    ...
    factory: AcademicLevelFactory = Depends(
        get_authenticated_factory(AcademicLevelFactory)
    ),
):
...
@router.get(
    "/levels/{level_id}/subjects", response_model=List[AcademicLevelSubjectResponse]
)
def get_level_classes(
