...
from app.core.shared.models.enums import ClassCode
...
class AcademicLevel(Base, AuditMixins, TimeStampMixins, ArchiveMixins):
    ...
    subjects: Mapped[List["AcademicLevelSubject"]] = relationship(
...
class Classes(Base, AuditMixins, TimeStampMixins, ArchiveMixins):
    ...
    level_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "academic_levels.id",
            ondelete="RESTRICT",
            name="fk_classes_academic_levels_level_id",
        )
    )
    ...
    supervisor_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "educators.id",
            ondelete="SET NULL",
            name="fk_classes_educators_supervisor_id",
        ),
        nullable=True,
    )
    student_rep_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "students.id", ondelete="SET NULL", name="fk_classes_students_student_rep"
        ),
        nullable=True,
    )
    assistant_rep_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "students.id", ondelete="SET NULL", name="fk_classes_students_assistant_rep"
        ),
        nullable=True,
    )
...
class StudentDepartment(Base, AuditMixins, TimeStampMixins, ArchiveMixins):
    ...
    mentor_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "educators.id",
            ondelete="RESTRICT",
            name="fk_student_departments_educators_mentor_id",
        ),
        nullable=True,
    )
    student_rep_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "students.id",
            ondelete="RESTRICT",
            name="fk_student_departments_students_student_rep",
        ),
        nullable=True,
    )
    assistant_rep_id: Mapped[UUID] = mapped_column(
        ForeignKey(
            "students.id",
            ondelete="RESTRICT",
            name="fk_student_departments_students_assistant_rep",
        ),
        nullable=True,
    )
    ...
    mentor: Mapped["Educator"] = relationship(
        back_populates="mentored_department",
        foreign_keys="[StudentDepartment.mentor_id]",
    )
    subjects: Mapped[List["Subject"]] = relationship(back_populates="department")

    student_rep: Mapped["Student"] = relationship(
        "Student",
        back_populates="represented_department",
        foreign_keys="[StudentDepartment.student_rep_id]",
    )
    assistant_rep: Mapped["Student"] = relationship(
        "Student",
        back_populates="assistant_represented_department",
