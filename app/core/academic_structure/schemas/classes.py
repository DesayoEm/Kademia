...
from app.core.shared.schemas.enums import ArchiveReason, ClassCode
...
class ClassBase(BaseModel):
    ...
    model_config = ConfigDict(
        ...
        extra="ignore",
        json_schema_extra={
            "example": {"level_id": "00000000-0000-0000-0000-000000000000", "code": "A"}
        },
    )
...
class ClassUpdate(BaseModel):
    ...
    model_config = ConfigDict(
        from_attributes=True,
        extra="ignore",
        json_schema_extra={"example": {"order": "0", "code": "B"}},
    )
