...
from V2.app.services.staff_organization.factories.staff_roles import StaffRolesFactory
from V2.app.schemas.staff_organization.staff_roles import StaffRoleCreate, StaffRoleUpdate, RolesFilterParams
...
@pytest.fixture
def mock_repository():
    with patch("V2.app.services.staff_organization.factories.staff_roles.SQLAlchemyRepository") as mock:
...
def test_create_staff_role(mock_repository):
    ...
    with patch("V2.app.services.staff_organization.factories.staff_roles.StaffOrganizationValidators") as validator_mock:
...
def test_get_all_roles(mock_repository):
    ...
    session_mock = MagicMock()
    with patch("V2.app.services.staff_organization.factories.staff_roles.StaffOrganizationValidators"):
        factory = StaffRolesFactory(session_mock)
