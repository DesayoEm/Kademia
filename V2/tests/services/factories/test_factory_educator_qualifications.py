...
from V2.app.services.staff_organization.factories.educator_qualifications import QualificationsFactory
from V2.app.schemas.staff_organization.educator_qualifications import QualificationCreate, QualificationUpdate, QualificationFilterParams
from V2.app.database.models.data_enums import ArchiveReason
from V2.app.services.errors.database_errors import EntityNotFoundError, UniqueViolationError
from V2.app.services.errors.staff_organisation_errors import QualificationNotFoundError, DuplicateQualificationError


@pytest.fixture
def mock_repository():
    with patch("V2.app.services.staff_organization.factories.educator_qualifications.SQLAlchemyRepository") as mock:
...
def test_create_qualification(mock_repository):
    ...
    with patch("V2.app.services.staff_organization.factories.educator_qualifications.StaffOrganizationValidators") as validator_mock:
...
def test_get_all_qualifications(mock_repository):
    ...
    session_mock = MagicMock()
    with patch("V2.app.services.staff_organization.factories.educator_qualifications.StaffOrganizationValidators"):
        factory = QualificationsFactory(session_mock)
...
def test_get_qualification_not_found(mock_repository):
    ...
    mock_instance, test_uuid, _ = mock_repository
    mock_instance.get_by_id.side_effect = EntityNotFoundError(entity_type="EducatorQualifications")
...
def test_delete_qualification_not_found(mock_repository):
    ...
    mock_instance.delete.side_effect = EntityNotFoundError(entity_type="EducatorQualifications")
...
def test_get_archived_qualification_not_found(mock_repository):
    ...
    mock_instance.get_archive_by_id.side_effect = EntityNotFoundError(entity_type="EducatorQualifications")
...
def test_delete_archived_qualification_not_found(mock_repository):
    ...
    mock_instance.delete_archive.side_effect = EntityNotFoundError(entity_type="EducatorQualifications")
