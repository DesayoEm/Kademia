...
class Students(ProfileBase):
    ...
    parent_id: Mapped[UUID] = mapped_column(UUID(as_uuid=True),ForeignKey('parents.id',
    ...
    transfers: Mapped[List['StudentDepartmentTransfers']] = relationship(back_populates='transferred_student')
...
class Parents(ProfileBase):
    ...
    __table_args__ = (
        Index('idx_parents_name', 'first_name', 'last_name'),
