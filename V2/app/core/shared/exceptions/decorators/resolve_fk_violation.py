...
from V2.app.core.shared.exceptions.maps.fk_mapper import fk_error_map
from V2.app.core.shared.exceptions import RelationshipError, RelatedEntityNotFoundError
...
class FKResolver:
    ...
    def resolve_fk_violation(factory_class, error_message, context_obj, operation, fk_map):
        ...
        Args:
            ...
            error_message (str): The raw error message from the db (usually from a ForeignKeyViolation).
