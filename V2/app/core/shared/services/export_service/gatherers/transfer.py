...
class TransferGatherer:
    ...
    @staticmethod
    def gather_class_transfer_data(transfer: ClassTransfer) -> Tuple[Dict[str, Any], str]:
        """Gather data for ClassTransfer entity."""
        file_name = f"ClassTransfer_{transfer.student_id}_{transfer.academic_year}"
        ...
        return ({
                    ...
                    "previous_class": {
                        "id": str(transfer.previous_class.id),
                        "code": transfer.previous_class.code
                    } if transfer.previous_class else None,
                    "new_class": {
                        "id": str(transfer.new_class.id),
                        "code": transfer.new_class.code
                    } if transfer.new_class else None,
                    "status_updated_by": {
    ...
    @staticmethod
    def gather_student_department_transfer_data(transfer: StudentDepartmentTransfer) -> Tuple[Dict[str, Any], str]:
