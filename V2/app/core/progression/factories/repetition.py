...
class RepetitionFactory:
    ...
    def __init__(self, session: Session, model=Repetition):
        self.model = model
    ...
    def update_repetition(self, repetition_id: UUID, data: dict) -> Repetition:
        ...
        try:
            ...
            return self.repository.update(repetition_id, existing)
    ...
    def archive_repetition(self, repetition_id: UUID, reason) -> Repetition:
        ...
        try:
            ...
            return self.repository.archive(repetition_id, SYSTEM_USER_ID, reason)
