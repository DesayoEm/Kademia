...
def test_model_structure_default_values(db_inspector):
    ...
    fields_without_defaults = [
        'id', "student_id", "academic_year", "previous_class_id","new_class_id"
        ,"reason","status","status_updated_by","status_updated_at","rejection_reason",
        "created_at","last_modified_at","is_archived", "archived_at","archived_by",
